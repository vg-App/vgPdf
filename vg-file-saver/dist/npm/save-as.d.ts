// To list new API calls to the File Saver documentation, manually add them to `vg-file-saver/docs/api`.
// Due to the specifics of the component and unlike the other vg UI components for Angular,
