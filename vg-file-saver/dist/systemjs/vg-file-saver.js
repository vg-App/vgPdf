System.register('@vgPdf/vg-file-saver', [], function(a) {
  return {
    setters: [],
    execute: function() {
      !(function(r) {
        ...
        function(e, t) {
          ...
          Object.defineProperty(t, '__esModule', { value: !0 }),
            (t.saveAs = function(e, t) {
              ...
              r.forceProxy || (n() && (o = c), navigator.msSaveBlob && (o = i))
              o(e, t, r)
            })
          var a = function() {
          ...
          function u(e, t, r) {
            if (r.proxyURL) {
              ...
              for (var i in ((n.contentType = a[0].replace('data:', '')),
              (n.base64 = a[1]),
              n))
            ...
            (t.encodeBase64 = function(e) {
              ...
              for (; d < t.length; )
                (o = t.charCodeAt(d++)),
                  ...
                  (u = ((15 & n) << 2) | (a >> 6)),
                  (s = 63 & a),
                  isNaN(n) ? (u = s = 64) : isNaN(a) && (s = 64),
                  (r =
                    r + f.charAt(i) + f.charAt(c) + f.charAt(u) + f.charAt(s))
              return r
            })
          var f =
