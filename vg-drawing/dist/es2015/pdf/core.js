...
function PDFDocument(options) {
    ...
    var info = self.attach(new PDFDictionary({
        Producer     : new PDFString(getOption("producer", "vg UI PDF Generator")), // XXX: vg.version?
        ...
        Creator      : new PDFString(getOption("creator", "vg UI PDF Generator")),
        ...
        if (!size && blob && /^image\/jpe?g$/i.test(blob.type)) {
            ...
            reader.onload = function() {
                try {
                    ...
                    // https://github.com/telerik/vg-ui-core/issues/4184).  If that's the case,
...
function PDFJpegImage(data) {
    ...
    // through the canvas.
    // https://github.com/telerik/vg-ui-core/issues/2845
    data.offset(0);
