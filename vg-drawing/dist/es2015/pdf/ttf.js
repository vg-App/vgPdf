...
var GlyfTable = (function() {
  ...
  return deftable({
    ...
    glyphFor: function(id) {
      ...
      var glyph = (cache[id] =
        numberOfContours == -1 ? new CompoundGlyph(raw) : new SimpleGlyph(raw))
  ...
  return deftable({
    ...
    render: function(psName) {
      ...
      for (i in strings) {
        if (hasOwnProperty(strings, i)) {
          var list =
            i == 6 ? [new NameEntry(psName, this.postscriptEntry)] : strings[i]
          ...
          for (i = 0; i < segCount; ++i) {
            ...
            for (code = start; code <= end; ++code) {
              ...
              if (idRangeOffset[i] === 0) {
                ...
                ///
                var index =
                  idRangeOffset[i] / 2 - (segCount - i) + (code - start)
