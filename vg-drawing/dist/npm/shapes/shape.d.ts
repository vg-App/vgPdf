...
export abstract class Shape<T> extends Element {
   ...
   *
   * @param color - The [fill color]({% slug api_vg-drawing_filloptions %}#toc-color) to set.
   * @param opacity - The [fill opacity]({% slug api_vg-drawing_filloptions %}#toc-opacity) to set.
   * @return - The current instance to allow chaining.
   */
  fill(color: string, opacity?: number): T;

  /**
   * Sets the [stroke]({% slug api_vg-drawing_strokeoptions %}) of the Shape.
   *
   * @param color - The [stroke color]({% slug api_vg-drawing_strokeoptions %}#toc-color) to set.
   * @param width - The [stroke width]({% slug api_vg-drawing_strokeoptions %}#toc-width) to set.
   * @param opacity - The [stroke opacity]({% slug api_vg-drawing_strokeoptions %}#toc-opacity) to set.
   * @return - The current instance to allow chaining.
   */
