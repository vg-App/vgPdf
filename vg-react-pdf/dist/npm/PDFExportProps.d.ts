import { PaperSize, PageMargin } from '@vgPdf/vg-drawing/pdf';
/**
 * Represents the props of the vgReact PDFExport component.
 */
export interface PDFExportProps {
    ...
    /**
     * A React functional or class component which is used as a template that is inserted
